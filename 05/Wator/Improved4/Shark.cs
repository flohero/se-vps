...
namespace VPS.Wator.Improved4
{
    public class Shark : Animal
    {
        ...
        public Shark(Improved4WatorWorld world, Point position, int energy)
          : base(world, position)
        {
            Energy = energy;
        }
        ...
        public override void ExecuteStep()
        {
            ...
            if (fish.X != -1)
            {
                ...
                Energy += World.Grid[fish.X + fish.Y * World.Width].Energy;
                Move(fish);
            }
            else
            ...
            if (Energy <= 0) World.Grid[Position.X + Position.Y * World.Width] = null;  // not enough energy -> die
        }
