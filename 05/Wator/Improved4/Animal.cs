...
namespace VPS.Wator.Improved4
{
    ...
    public abstract class Animal
    {
        ...
        public Improved4WatorWorld World { get; private set; }
        ...
        public Animal(Improved4WatorWorld world, Point position, bool isShark = false)
        {
            World = world;
            Position = position;
            Age = 0;
            ...
            World.Grid[position.X + position.Y * World.Width] = this;
        }
        ...
        {
            World.Grid[Position.X + Position.Y * World.Width] = null;
            World.Grid[destination.X + destination.Y * World.Width] = this;
